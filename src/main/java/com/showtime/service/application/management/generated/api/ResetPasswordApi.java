...
public interface ResetPasswordApi {
    ...
    @ApiOperation(value = "User Reset Password", nickname = "userResetpassword", notes = "", response = Response.class, tags={ "AllUsers", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "*OK* - User modified successfully. ", response = Response.class) })
    @RequestMapping(value = "/resetPassword",
        produces = { "application/json;charset=utf-8" }, 
        consumes = { "application/json;charset=utf-8" },
        method = RequestMethod.POST)
    default ResponseEntity<Response> userResetpassword(@ApiParam(value = "User signing in Details " ,required=true )  @Valid @RequestBody Credentials credentials,@ApiParam(value = "The locale of the client " ) @RequestHeader(value="Accept-Language", required=false) String acceptLanguage) {
