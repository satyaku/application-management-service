...
import com.showtime.service.application.management.generated.api.SignUpApi;
...
public class SignUpApiController implements SignUpApi {
    ...
    public ResponseEntity<Response> userSignUp(@ApiParam(value = "User signing in " ,required=true )  @Valid @RequestBody SignUpDetails signUpDetails,@ApiParam(value = "The locale of the client " ) @RequestHeader(value="Accept-Language", required=false) String acceptLanguage) {
