...
import com.showtime.service.application.management.generated.api.SignInApi;
...
public class SignInApiController implements SignInApi {
    ...
    public ResponseEntity<Response> userSignIn(@ApiParam(value = "User signing in " ,required=true )  @Valid @RequestBody Credentials credentials,@ApiParam(value = "The locale of the client " ) @RequestHeader(value="Accept-Language", required=false) String acceptLanguage) {
